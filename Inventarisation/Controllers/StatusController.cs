...
namespace Inventarisation.Controllers
{
    public class StatusController : Controller
    {
        ...
        public StatusController(MyAppContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Statuses.OrderBy(c=>c.Id).ToListAsync());
        }
        ...
        {
            //ModelState.AddModelError("Name", "тестируем ошибки");
